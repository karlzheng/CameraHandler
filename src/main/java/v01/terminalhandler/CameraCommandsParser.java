...
public class CameraCommandsParser {
    ...
    private final Map<String, List<CommandList.CamMethod>> commandList = new HashMap<>();

    public CameraCommandsParser(){
        Map<String, List<CommandList.CamMethod>> map = CommandList.getCommands();
        List<CommandList.CamMethod> temp = null;
